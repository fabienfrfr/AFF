...
################################ AGENT
class Q_AGENT():
    def __init__(self, NB_P_GEN, IO, BS, NET = None, COOR = None):
        self.P_MIN = 1
        self.NB_P_GEN = NB_P_GEN
        # I/O
    ...
    def RESET(self):
        ...
        return Q_AGENT(self.NB_P_GEN, self.IO, self.batch_size, NET = GRAPH, COOR = XY_TUPLE)
    
    ## mutation
    def LAUNCH_MUTATION(self, MUT = None):
